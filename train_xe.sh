python train.py \
    ...
    --checkpoint_path '/2t/ylc/im2p/log_xe_3lay_2/' \
    --id 'xe' \
    --print_freq 200 \
    --fc_feat_size 2048 \
    --att_feat_size 2048 \
    --gcn_layers 1 \
    --no-avg-feat \
    #--pretrain_rel "/shared_home/ylc/im2p/relation/model_bg_noact_batchnorm/ep4-acc75.33.pt" \
    #--pretrain_rel "/shared_home/ylc/im2p/relation/model_bg_noactivation/ep10-acc85.64.pt" \
