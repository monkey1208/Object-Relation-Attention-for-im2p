...
def parse_opt():
    ...
    parser.add_argument('--w2v', default='w2v.npy', type=str, help='path to w2v.npy')
    parser.add_argument('--sg_dir', type=str, default=None,
                    help='path to vg-sgg directory')
    ...
    parser.add_argument('--load_gcn', type=str, default='gcn_model.pth')
    parser.add_argument('--pretrain_rel', type=str, default=None)
    ...
    parser.add_argument('--gcn_hidden', type=int, default=2048,
                    help='hidden size in gcn layer')
    parser.add_argument('--obj_embedding', type=int, default=0,
                    help='obj embedding size')
    parser.add_argument('--use_concat_feat', action='store_true',
                    help='use concat obj embedding')
    parser.add_argument('--do-avg-feat', action='store_true', dest='avg_feat')
    parser.add_argument('--no-avg-feat', action='store_false', dest='avg_feat')
    # Model settings
